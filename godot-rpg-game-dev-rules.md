...
### 6. 데이터 영속성 (Persistence Strategy)
...
### 2. 폴더 구조 합의 (Directory Structure Consensus)
...
### 3. 씬 및 포탈 표준 (Scene & Portal Standards)
...
### 4. 문서화 원칙 (Documentation as Memory)
...
### 5. 리소스 및 씬 파일 조작 가이드 (Resource & Scene Handling)
